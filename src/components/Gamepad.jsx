    ...
    return (
        <>
            <div className='absolute h-full top-0 start-0 w-full'>
                <div onClick={() => setShow(false)} className='absolute bg-black z-10 opacity-[0.4] w-full min-h-full h-full top-0 start-0'></div>
                <div className="container max-w-[1440px] mx-auto w-full relative z-20">
