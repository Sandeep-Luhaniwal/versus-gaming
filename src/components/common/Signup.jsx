                            ...
                            <form>
                                <div className="py-4 sm:py-6">
                                    ...
                                    <div className="flex justify-between items-center bg-black mt-2 mb-4 pe-4 rounded-xl">
                                        <input type={show} id='userpassword' required className='autofill:bg-black w-full py-4 rounded-xl ps-4 pe-3 bg-black text-black-400 placeholder:text-black-400 focus:outline-none font-normalidad font-normal leading-4 tracking-[0.14px] text-sm' placeholder='Your passwrod here' />
                                    ...
                                    <div className="flex justify-between items-center bg-black mt-2 pe-4 rounded-xl">
                                        <input type={confirm} id='confirmpassword' required className='autofill:bg-black w-full py-4 rounded-xl ps-4 pe-3 bg-black text-black-400 placeholder:text-black-400 focus:outline-none font-normalidad font-normal leading-4 tracking-[0.14px] text-sm' placeholder='Your passwrod here' />
